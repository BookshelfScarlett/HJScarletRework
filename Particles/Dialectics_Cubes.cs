...
{
    public class Dialectics_Cubes : BaseParticle
    {
        public bool NeedGlowEdge;
        public Color GlowEdgeColor;
        public bool AffectedByGravity;
        public float DrawRotation = 0f;
        public Dialectics_Cubes(Vector2 position, Vector2 velocity, int lifetime, Color drawColor, float scale, bool affectedByGravity, bool needGlowEdge = false, Color? glowEdgeColor = null)
        {
            Position = position;
            Velocity = velocity;
            Lifetime = lifetime;
        ...
        {
            Texture2D texture = HJScarletTexture.Specific_DialectCube.Value;

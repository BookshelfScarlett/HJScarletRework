...
{
    public class TrailShinyOrb : BaseParticle
    {
        public override int UseBlendStateID => BlendStateID.Additive;
        public float BeginScale;
        public List<Vector2> OldPos = [];
        public bool UseSlowDown = false;
        public TrailShinyOrb(Vector2 position, Vector2 velocity, Color color, int lifetime, float scale)
        {
            Position = position;
            Velocity = velocity;
            DrawColor = color;
        ...
        public TrailShinyOrb(Vector2 position, Vector2 velocity, Color color, int lifetime, float scale, bool useSlowDown)
        {
            Position = position;
            Velocity = velocity;
            DrawColor = color;
        ...
        {
            Scale = Lerp(BeginScale, 0f, EaseOutCubic(LifetimeRatio));

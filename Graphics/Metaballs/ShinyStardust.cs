...
{
    public class ShinyStardust : BaseMetaball
    {
        ...
        public override Color EdgeColor => Color.Lerp(Color.AliceBlue, Color.RoyalBlue, 0.65f);
        ...
        public override Texture2D BackgroundTexture => HJScarletTexture.Metaball_ShinyStardust.Value;

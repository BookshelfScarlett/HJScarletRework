...
namespace HJScarletRework.Items
{
    public class Wreach : HJScarletWeapon
    {
        ...
        public override void ExSD()
        {
            ...
            Item.shoot = ProjectileType<DeepToneMinion>();
            Item.shootSpeed = 10f;
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            //Projectile proj = Projectile.NewProjectileDirect(source, ownerMW, Vector2.Zero, ProjectileType<DeepToneMinion>(), damage, knockback, player.whoAmI);
            //添加需要的攻击单位
            return true;
        }
    }

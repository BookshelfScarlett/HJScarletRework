...
namespace HJScarletRework.Assets.Registers
{
    public class HJScarletSounds
    {
        ...
        public static SoundStyle Atom_StrikeAlt => new SoundStyle($"{SoundsPath}{nameof(Atom_Strike)}", numVariants: 3);
        public static SoundStyle[] Atom_Strike => [Atom_Strike1, Atom_Strike2, Atom_Strike3];
        ...
        public static SoundStyle Gaia_Toss => new SoundStyle($"{SoundsPath}{nameof(Gaia_Toss)}", numVariants: 2);
        ...
        public static SoundStyle Hammer_ShootAlt => new SoundStyle($"{SoundsPath}{nameof(Hammer_Shoot)}", numVariants: 3);
        public static SoundStyle[] Hammer_Shoot => [Hammer_Shoot1, Hammer_Shoot2, Hammer_Shoot3];
        ...
        public static SoundStyle[] Misc_KnifeToss => [Misc_KnifeToss1, Misc_KnifeToss2, Misc_KnifeToss3];
        ...
        public static SoundStyle[] Smash_AirHeavy => [Smash_AirHeavy1, Smash_AirHeavy2];
        ...
        public static SoundStyle TheSevenStar_Hit => new SoundStyle($"{SoundsPath}{nameof(TheSevenStar_Hit)}");
        public static SoundStyle TheSevenStar_Swing => new SoundStyle($"{SoundsPath}{nameof(TheSevenStar_Swing)}", numVariants: 2);

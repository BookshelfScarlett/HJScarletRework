...
namespace HJScarletRework.Globals.Graphics.Metaballs
{
    public class GreenWater: BaseMetaball
    {
        ...
        public override Color EdgeColor => Color.Lerp(Color.DarkGreen, Color.DarkSeaGreen, 0.64f);
        public static List<GreenWaterParticle> ParticleList = [];
        public override Texture2D BackgroundTexture => HJScarletTexture.Metaball_GreenWater.Value;

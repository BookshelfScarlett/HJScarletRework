...
namespace HJScarletRework.Projs.Executor
{
    public class BinaryStarsProj: ThrownHammerProj, ILocalizedModType
    {
        ...
        private void SpawnSkyFallHammer()
        {
            ...
            Projectile extraHammer = Projectile.NewProjectileDirect(Projectile.GetSource_FromThis(), pos, vel, ProjectileType<BinaryStarsExecution>(), Projectile.damage / 2, Projectile.knockBack);

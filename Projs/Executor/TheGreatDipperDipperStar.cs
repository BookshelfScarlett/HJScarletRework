...
{
    public class TheGreatDipperDipperStar : HJScarletProj
    {
        ...
        public override void ProjAI()
        {
            ...
            if (AttackState == State.Following)
            {
                ...
                //这里只管存货，实际的控制由父射弹管理
                if ((proj != null && proj.active && proj.type == ProjectileType<TheGreatDipperDipper>()) && Owner.HeldItem.type == ItemType<TheGreatDipper>())
                {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color c = Color.Lerp(Color.RoyalBlue, Color.CornflowerBlue, Projectile.localAI[1] / 6f);
            float generalScale = 2.6f * Projectile.Opacity;
            ...
            SB.Draw(orb, pos, null, Color.White * .64f, 0, orb.Size() / 2f, .15f * generalScale, 0, 0);
            SB.EndShaderArea();
            return false;
        }

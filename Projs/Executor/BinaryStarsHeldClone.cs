...
{
    public class BinaryStarsHeldClone: HJScarletProj
    {
        ...
        private void PrettySpark(int hitDamage)
        {
            ...
            for (int i = 0; i < 36; i++)
            {
                ...
                new ShinyOrbParticle(pos, dir2 * 5f, Main.rand.NextBool() ? Color.White : Color.HotPink, 40, 3.5f - Math.Abs(18f - i) / 6f).Spawn();
            }
            //从灾厄抄写的锤子特效

...
namespace HJScarletRework.Projs.Executor
{
    public class TheSevenStarBolt : HJScarletProj
    {
        ...
        public override void ProjAI()
        {
            ...
            ECSParticle.LightntingGlow(Projectile.Center, Projectile.velocity.ToSafeNormalize(), RandLerpColor(Color.LightSkyBlue, Color.SkyBlue), 50, 1, 0.4f,3);
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            //InitParticle(initPos);
                    ...
                    for (int i = 0; i < 3; i++)
                    {
                        ...
                        new NoiseShockRing(Projectile.Center, Vector2.Zero, color, 45, 1f, .05f + i * 0.032f, Projectile.whoAmI, Vector2.Zero, false).Spawn();
                    }
                    for (int i = 0; i < 10; i++)

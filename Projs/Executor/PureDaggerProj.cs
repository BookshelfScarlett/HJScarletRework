...
{
    public class PureDaggerProj : ExecutorHeldProj, IPixelatedRenderer
    {
        ...
        public override void ModifyHitNPC(NPC target, ref NPC.HitModifiers modifiers)
        {
            ...
            foreach (var p in Main.ActiveProjectiles)
            {
                if (p.owner != Projectile.owner)
                    continue;
                if (p.type != ProjectileType<PureDaggerStar>())
                    continue;
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                Projectile proj = Projectile.NewProjectileDirect(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity, ProjectileType<PureDaggerExecution>(), Projectile.originalDamage, Projectile.knockBack, Projectile.owner);

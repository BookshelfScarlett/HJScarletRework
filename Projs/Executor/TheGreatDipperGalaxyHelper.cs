...
{
    public class TheGreatDipperGalaxyHelper : ExecutorHeldProj, IPixelatedRenderer
    {
        public override int OriginalItemID => ItemType<TheGreatDipper>();
        public override EnumDamageClass Category => EnumDamageClass.Executor;
        public override string Texture => GetInstance<TheGreatDipper>().Texture;
        ...
        {
            Owner.KillCertainProj(ProjectileType<TheGreatDipperHeldProj>());
            if (!Helper.IsDone[0])
            {

...
namespace HJScarletRework.Projs.Melee
{
    public class DeepToneThrownProj : ThrownSpearProjClass
    {
        ...
        public void DoShoot()
        {
            ...
            d.noGravity = true;
            new TurbulenceShinyOrb(mountedPos + Main.rand.NextVector2Circular(6f, 6f), 1.2f, Color.DarkOliveGreen.RandLerpTo(Color.DarkSeaGreen), 40, 0.1f, Projectile.SafeDir().ToRotation()).SpawnToPriority();

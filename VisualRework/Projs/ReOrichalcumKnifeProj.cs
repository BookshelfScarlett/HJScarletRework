    ...
    public class ReOrichalcumKnifeProj : ReVisualProjClass
    {
        ...
        public override void PreDrawRevisual(Projectile proj, ref Color lightColor)
        {
            ...
            for (int i = 0; i < PosList.Count; i++)
            {
                ...
                Color drawColor2 = (Color.Lerp(Color.HotPink, Color.White, rads).ToAddColor(150)) * colorRads;
            ...
            SB.Draw(tex, drawPos, null, lightColor, proj.velocity.ToRotation() + PiOver4, tex.ToOrigin(), proj.scale, 0, 0);
        }
    }
}

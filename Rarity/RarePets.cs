...
namespace HJScarletRework.Rarity
{
    public class RarePets : ModRarity
    {
        ...
        public static void DrawCustomTooltipLine(DrawableTooltipLine tooltipLine)
        {
            ...
            Main.spriteBatch.Draw(HJScarletTexture.Texture_RarityGlow.Value, glowPosition, null, Color.SkyBlue.ToAddColor() * 0.85f, 0f, HJScarletTexture.Texture_RarityGlow.Origin, glowScale, SpriteEffects.None, 0f);
            ...
            Color mainTextColor = Color.Lerp(Color.DeepSkyBlue, Color.SkyBlue, 0.9f);
